      ...
      <div className={`logo-section ${property1}`}>
        {(property1 === "EOAR" ||
          ...
          <div className="logo-svg">
            <div className="div">ZeroTrust 360</div>
          </div>
        )}

        {property1 === "policy-and-control" && (
          <>
            <img className="line" alt="Line" src="/img/line-376-7.svg" />
            <div className="menu-items">
              <div className="div-2">
                <div className="group-2">
                  <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-useroctagon-3.svg" />
              ...
              <div className="customer-2">
                <div className="frame-4">
                  ...
                  <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-building4-1.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-4">
                  <div className="text-wrapper-2">Incident Monitoring</div>
                  <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1-8.svg" />
                </div>
                <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
              </div>
              <div className="customer-2">
        ...
        {property1 === "side-menu" && (
          <>
            ...
            <div className="settings">
              <div className="frame-2">
                <div className="text-wrapper-2">Check Point</div>
                <img className="iconsax-linear-3" alt="Iconsax linear" src={img} />
              </div>
              <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
            </div>
            <div className="div-2">
              <img className="iconsax-linear-10" alt="Iconsax linear" src={iconsaxLinear1} />
              <div className="group-5">
                <div className="text-wrapper-3">Enforcement Point</div>
                <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
              </div>
            ...
            <div className="customer-2">
              <div className="frame-4">
                <div className="text-wrapper-2">Trust Observability</div>
                <img className="img" alt="Iconsax linear" src={iconsaxLinear2} />
              </div>
            </div>
            <div className="customer-2">
              <div className="frame-4">
                <div className="text-wrapper-2">Incident Monitoring</div>
                <img className="img" alt="Iconsax linear" src={iconsaxLinear3} />
              </div>
              <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
            </div>
            <div className="customer-2">
              <div className="frame-4">
                <img className="iconsax-linear-8" alt="Iconsax linear" src={iconsaxLinear4} />
                <div className="text-wrapper-2">Activity Log</div>
              </div>
            </div>
          </>
                ...
                <img
                  ...
                  src={
                    ["EOAR", "incident-monitoring-expand"].includes(property1)
                      ...
                      : "/img/iconsax-linear-useroctagon-3.svg"
                  }
                />
                <div className="AI-policies-controls">AI Policies &amp; Controls</div>
              </div>
                ...
                <div className="roles-4">
                  <div className="frame-5">
                    {property1 === "incident-monitoring-expand" && (
                      <>
                        <div className="text-wrapper-2">Incident Monitoring</div>
                        <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1-4.svg" />
                      </>
                    )}
                    ...
                    <>
                      <div className="frame-6">
                        {property1 === "compliance-moitoring" && (
                          <>
                            <div className="text-wrapper-2">Incident Monitoring</div>
                            <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1-5.svg" />
                          </>
                        )}
              ...
              <div className="customer-7">
                ...
                {property1 === "EOAR" && (
                  <>
                    <div className="frame-4">
                      <div className="text-wrapper-2">Incident Monitoring</div>
                      <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1-1.svg" />
                    </div>
                    <img
                      className="iconsax-linear-4"
                      alt="Iconsax linear"
