...
export const AutotestingEditor = ({ className }) => {
  return (
    <div className={`autotesting-editor ${className}`}>
      <div className="group">
        <p className="pipeline-name">
          <span className="text-wrapper">pipeline: &nbsp;&nbsp; name:&nbsp;&nbsp;</span>
          <span className="span">AutoCheckingYaml</span>
          <span className="text-wrapper"> &nbsp;&nbsp; ExecutionParam1: &nbsp;&nbsp;&nbsp;&nbsp; -gpu_enabled:</span>
          <span className="span"> true</span>
          <span className="text-wrapper"> &nbsp;&nbsp;&nbsp;&nbsp; -max_pooling_size: </span>
          <span className="span">50</span>
          <span className="text-wrapper"> &nbsp;&nbsp;&nbsp;&nbsp; -caching_enabled: </span>
          <span className="span">false</span>
          <span className="text-wrapper"> &nbsp;&nbsp;&nbsp;&nbsp; -execution_mode: </span>
          <span className="span">silent</span>
          <span className="text-wrapper">
            {" "}
            &nbsp;&nbsp; test_twin: &nbsp;&nbsp;&nbsp;&nbsp;twin01: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name:{" "}
          </span>
          <span className="span">test-twin01</span>
          <span className="text-wrapper">
            {" "}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;property: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- tags:
            [ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#39;
