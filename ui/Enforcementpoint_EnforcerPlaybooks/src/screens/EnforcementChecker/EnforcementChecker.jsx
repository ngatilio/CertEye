...
export const EnforcementChecker = () => {
  return (
    <div className="enforcement-checker">
      <div className="div-5">
        <div className="overlap-2">
          ...
          <div className="frame-6">
            <div className="frame-7">
              ...
              <div className="text-wrapper-4">Success</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-2" />
              <div className="text-wrapper-4">Running</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-3" />
              <div className="text-wrapper-4">Failed</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-4" />
              <div className="text-wrapper-4">Skipped</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-5" />
              <div className="text-wrapper-4">Retry</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-6" />
              <div className="text-wrapper-4">Queued</div>
            </div>
            <div className="frame-7">
              <div className="rectangle-7" />
              <div className="text-wrapper-4">No-status</div>
            </div>
          </div>
          ...
          <div className="text-wrapper-5">Execution log</div>
          <div className="text-wrapper-6">GPU Memory Usage</div>
            ...
            <div className="frame-8">
              <div className="overlap-4">
                ...
                <div className="group-18">
                  <div className="overlap-group-3">
                    <div className="text-wrapper-7">load_training_data_to_s3</div>
                  </div>
                </div>
              </div>
              <div className="overlap-5">
                <div className="overlap-6">
                  <div className="overlap-7">
                    ...
                    <div className="group-19">
                      <div className="overlap-8">
                        <div className="text-wrapper-8">train_model</div>
                      </div>
                    </div>
                    <div className="group-20">
                      <div className="overlap-9">
                        <div className="text-wrapper-9">validate_model</div>
                      </div>
                    </div>
                  </div>
                  <div className="overlap-10">
                    ...
                    <div className="group-21">
                      <div className="overlap-11">
                        <div className="text-wrapper-10">Preprocess_data</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="overlap-12">
                    ...
                    <div className="group-22">
                      <div className="overlap-11">
                        <div className="text-wrapper-10">tune_parameters</div>
                      </div>
                    </div>
                    <div className="group-23">
                      <div className="overlap-13">
                        <div className="text-wrapper-11">audit_enforcer</div>
                      </div>
                    </div>
                  </div>
                  <div className="overlap-14">
                    ...
                    <div className="group-24">
                      <div className="overlap-15">
                        <div className="text-wrapper-11">security_enforcer</div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="group-25">
                  <div className="overlap-15">
                    <div className="text-wrapper-12">Privacy_enforcer</div>
                  </div>
                </div>
                <div className="group-26">
                  <div className="overlap-15">
                    <div className="text-wrapper-12">fairness_enforcer</div>
                  </div>
                </div>
              </div>
                ...
                <div className="overlap-17">
                  ...
                  <div className="group-27">
                    <div className="overlap-18">
                      <div className="text-wrapper-13">performance_enforcer</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="text-wrapper-14">download_model</div>
              <div className="text-wrapper-15">deploy_model</div>
        ...
        <div className="text-wrapper-18">Enforcer Playbooks</div>
        <Menu
