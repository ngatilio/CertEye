...
export const Menu = ({
  ...
  iconsaxLinear3 = "/img/iconsax-linear-arrowright2-14.svg",
  divClassNameOverride,
  iconsaxLinear4 = "/img/iconsax-linear-profile2user-7.svg",
  iconsaxLinear5 = "/img/iconsax-linear-arrowright2-10.svg",
            ...
            <div className="settings-3">
              {[
                ...
                <div className="group-6">
                  {property1 === "check-point" && <div className="div-3">AI Testing Pipeline</div>}
                ...
                <div className="customer-4">
                  <div className="group-10">
                    {[
                      ...
                      <div className={`div-3 ${property1 === "check-point" ? divClassNameOverride : undefined}`}>
