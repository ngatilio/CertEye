      ...
      <div className={`logo-section ${property1}`}>
        {(property1 === "EOAR" ||
          ...
          <div className="logo-svg">
            <div className="text-wrapper-11">ZeroTrust 360</div>
          </div>
        )}

        {property1 === "policy-and-control" && (
          <>
            <img className="line-2" alt="Line" src="/img/line-376-7.svg" />
            <div className="menu-items">
              <div className="div-2">
                ...
                <img className="iconsax-linear-2" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
              </div>
              <div className="roles">
                <div className="div-wrapper">
                  <div className="div-3">NRS Database</div>
                </div>
              </div>
              <div className="roles">
                <div className="policies-controls-wrapper">
                  <div className="div-3">Policies &amp; controls</div>
                </div>
              </div>
              <div className="roles">
                <div className="group-2">
                  <div className="div-3">Estimated Readiness</div>
                </div>
              </div>
              <div className="settings">
                <div className="frame">
                  <div className="text-wrapper-12">Check Point</div>
                  <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-setting2-8.svg" />
                </div>
                <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
              </div>
              <div className="div-2">
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-profile2user-7.svg" />
                <div className="group-3">
                  <div className="text-wrapper-13">Enforcement Point</div>
              ...
              <div className="customer">
                ...
                <div className="group-4">
                  <div className="text-wrapper-13">Compliance Monitoring</div>
                  <img className="iconsax-linear-7" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-3">
                  <div className="text-wrapper-12">Trust Observability</div>
                  <img className="iconsax-linear" alt="Iconsax linear" src="/img/iconsax-linear-building4-1.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-3">
                  <div className="text-wrapper-12">Incident Monitoring</div>
              ...
              <div className="customer-2">
                <div className="frame-3">
                  <img className="iconsax-linear-8" alt="Iconsax linear" src="/img/iconsax-linear-activity-8.svg" />
                  <div className="text-wrapper-12">Activity Log</div>
                </div>
              </div>
            </div>
          </>
        ...
        {property1 === "side-menu" && (
          <>
            <div className="roles-2">
              <img className="iconsax-linear-9" alt="Iconsax linear" src={iconsaxLinear} />
              <div className="AI-policies-controls-2">AI Policies &amp; Controls</div>
              <img className="iconsax-linear-2" alt="Iconsax linear" src={img} />
            </div>
            <div className="settings">
              <div className="frame">
                <div className="text-wrapper-12">Check Point</div>
                <img className="iconsax-linear-3" alt="Iconsax linear" src={iconsaxLinear1} />
              </div>
              <img className="iconsax-linear-4" alt="Iconsax linear" src={iconsaxLinear2} />
            </div>
            <div className={`div-2 ${customerClassName}`}>
              <img className="iconsax-linear-10" alt="Iconsax linear" src={iconsaxLinear3} />
              <div className="group-3">
                <div className="text-wrapper-13">Enforcement Point</div>
                <img className="iconsax-linear-6" alt="Iconsax linear" src={iconsaxLinear4} />
              </div>
            </div>
            <div className="customer">
              ...
              <div className="group-4">
                <div className="text-wrapper-13">Compliance Monitoring</div>
                <img className="iconsax-linear-7" alt="Iconsax linear" src={iconsaxLinear5} />
              </div>
            </div>
            <div className={`customer-2 ${customerClassNameOverride}`}>
              <div className="frame-3">
                <div className={`text-wrapper-12 ${divClassName}`}>Trust Observability</div>
            ...
            <div className="customer-2">
              ...
              <img className="iconsax-linear-4" alt="Iconsax linear" src={iconsaxLinear8} />
            </div>
            <div className="customer-2">
              <div className="frame-3">
                <img className="iconsax-linear-8" alt="Iconsax linear" src={iconsaxLinear9} />
                <div className="text-wrapper-12">Activity Log</div>
              </div>
            </div>
          </>
        ...
        {(property1 === "EOAR" ||
          ...
          <div className="menu-items">
            ...
            <div className="settings-2">
              <div className="frame">
                <div className="text-wrapper-12">Check Point</div>
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-setting2-1.svg" />
              </div>
              <img
                ...
                src={
                  ["check-point", "checkpoint-2"].includes(property1)
                    ? "/img/iconsax-linear-arrowright2-5.svg"
                ...
                <div className="customer-3">
                  ...
                  <div className="group-5">
                    ...
                    <img
                      ...
                      src={
                        property1 === "compliance-moitoring"
                          ? "/img/iconsax-linear-arrowright2-13.svg"
                ...
                <div className="roles-4">
                  ...
                  {property1 === "incident-monitoring-expand" && (
                    <img
                      ...
                      alt="Iconsax linear"
                      src="/img/iconsax-linear-arrowright2-5.svg"
                    />
                  )}
                </div>
                  ...
                  {["compliance-moitoring", "enforcement-2", "enforcement"].includes(property1) && (
                    <>
                      <div className="frame-5">
                        ...
                        {["enforcement-2", "enforcement"].includes(property1) && (
                          <div className="div-3">Patching SandBox</div>
                        )}
                      </div>
                      <img
            ...
            {["EOAR", "compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <div className="customer-2">
                <div className="frame-3">
                  {property1 === "EOAR" && <div className="text-wrapper-12">Trust Observability</div>}
            ...
            {["checkpoint-2", "enforcement-2"].includes(property1) && (
              <>
                ...
                <div className="customer-6">
                  ...
                  {property1 === "enforcement-2" && (
                    <div className="group-2">
                      <div className="div-3">Ethics Auto patching</div>
                    </div>
                  )}
                </div>
              </>
              ...
              <>
                <div className="roles-7">
                  <div className="group-10">
                    <div className="div-3">AI EOAR</div>
                  </div>
                  <img className="iconsax-linear-14" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-5.svg" />
                </div>
                <div className="group-wrapper">
                ...
                <div className="roles-8">
                  <div className="group-15">
                    <div className="div-3">AI Ethics drift detection</div>
                  </div>
                </div>
                <div className="customer-2">
                  <div className="frame-3">
                    <img className="iconsax-linear-8" alt="Iconsax linear" src="/img/iconsax-linear-activity-1.svg" />
                    <div className="text-wrapper-12">Activity Log</div>
                  </div>
                </div>
              </>
