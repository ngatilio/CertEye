...
export const Header = ({ className, overlapClassName, iconsaxLinear = "/img/iconsax-linear-notification.svg" }) => {
  return (
    <div className={`header ${className}`}>
      <div className={`overlap ${overlapClassName}`}>
        <div className="frame-6">
          ...
          <img className="bi-people" alt="Bi people" src="/img/bi-people.svg" />
