          ...
          <div className="menu-items">
            <div className="roles-2">
              ...
              <img
                ...
                alt="Iconsax linear"
                src={
                  ["checkpoint-2", "enforcement-2"].includes(property1) ? img : "/img/iconsax-linear-arrowright2-12.svg"
                }
              />
            </div>
            {["checkpoint-2", "enforcement-2"].includes(property1) && (
              <div className={`settings-2 ${settingsClassName}`}>
                ...
                <img
                  className="img"
                  alt="Iconsax linear"
                  src={property1 === "enforcement-2" ? "/img/iconsax-linear-arrowright2-12.svg" : iconsaxLinear2}
                />
              </div>
            )}
                ...
                <div className="roles-4">
                  ...
                  {property1 === "checkpoint-2" && (
                    <img
                      ...
                      alt="Iconsax linear"
                      src="/img/iconsax-linear-arrowright2-16.svg"
                    />
                  )}
                </div>
                <div className="roles-5">
                  <div className="patching-sandbox-wrapper">
                    <div className={`patching-sandbox ${property1 === "checkpoint-2" ? divClassName1 : undefined}`}>
