...
import { DropDownArrow10 } from "../../icons/DropDownArrow10";
import { Button } from "../Button";
import { DropDownArrow } from "../DropDownArrow";
import "./style.css";

export const PoliciesAndControl = ({
  stateProp,
  className,
  ...
  return (
    <div
      className={`policies-and-control ${className}`}
      onClick={() => {
        dispatch("click");
      }}
    >
              ...
              {state.state === "active-state" && (
                <>
                  <div className="gender">
                    <div className="label">
                      <div className="location">NRS</div>
                    </div>
                    <div className="frame-3">
                      <div className="overlap-group">
                        <div className="filter-wrapper">
                          <div className="filter-5">Select NRS</div>
                        </div>
                        <DropDownArrow10 className="drop-down-arrow-10" />
                      </div>
                    </div>
                  </div>
                  <div className="div-2">
                    <div className="label">
                      <div className="location">Priority</div>
                    </div>
                    <div className="frame-3">
                      <div className="overlap-group">
                        <div className="filter-wrapper">
                          <div className="filter-5">Select priority</div>
                        </div>
                        <DropDownArrow10 className="drop-down-arrow-10" />
                      </div>
                    </div>
                  ...
                  <div className="div-4">
                    <div className="label">
                      <div className="location">Assignee</div>
                    </div>
                    <div className="frame-3">
                      <div className="overlap-group">
                        <div className="filter-wrapper">
                          <div className="filter-5">Select Assignee</div>
                        </div>
                        <DropDownArrow10 className="drop-down-arrow-10" />
                      </div>
                    </div>
