    ...
    <div className={`menu ${className}`}>
      <div className={`logo-section ${property1}`}>
        ...
        {property1 === "policy-and-control" && (
          <>
            <img className="line" alt="Line" src="/img/line-376.svg" />
            <div className="menu-items">
              <div className={`div ${rolesClassName}`}>
                <div className="group">
                  <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear} />
                  <div className={`AI-policies-controls ${AIPoliciesControlsClassName}`}>
                    AI Policies &amp; Controls
                  </div>
                </div>
                <img className="img" alt="Iconsax linear" src={img} />
              </div>
              <div className="roles">
                <div className="div-wrapper">
                  <div className={`div-2 ${divClassName}`}>NRS Database</div>
                </div>
              </div>
              <div className="roles">
              ...
              <div className="settings">
                ...
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-49.svg" />
              </div>
              <div className="div">
                ...
                <div className="group-3">
                  ...
                  <img className="iconsax-linear-5" alt="Iconsax linear" src={iconsaxLinear3} />
                </div>
              </div>
              <div className="customer">
                ...
                <div className="group-4">
                  ...
                  <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-49.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-3">
                  <div className="text-wrapper-2">Trust Observability</div>
                  <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear4} />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-3">
                  <div className="text-wrapper-2">Incident Monitoring</div>
                  <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear5} />
                </div>
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-49.svg" />
              </div>
              <div className="customer-2">
                <div className="frame-3">
                  <img className="iconsax-linear-7" alt="Iconsax linear" src={iconsaxLinear6} />
      ...
      <div className={`menu-items-2 property-1-${property1}`}>
        {property1 === "side-menu" && (
          <>
            <div className="roles-2">
              <img className="iconsax-linear-8" alt="Iconsax linear" src="/img/iconsax-linear-useroctagon-7.svg" />
              <div className="AI-policies-controls-2">AI Policies &amp; Controls</div>
              <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-46.svg" />
            </div>
            <div className="settings">
              <div className="frame">
                <div className="text-wrapper-2">Check Point</div>
              ...
              <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-46.svg" />
            </div>
            <div className="div">
              <img className="iconsax-linear-9" alt="Iconsax linear" src="/img/iconsax-linear-profile2user.svg" />
              <div className="group-3">
                <div className="text-wrapper-3">Enforcement Point</div>
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-46.svg" />
              </div>
            </div>
            <div className="customer">
              <img className="frame-2" alt="Frame" src="/img/frame-128-8.svg" />
              <div className="group-4">
                <div className="text-wrapper-3">Compliance Monitoring</div>
                <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-49.svg" />
              </div>
            ...
            <div className="customer-2">
              <div className="frame-3">
                <div className="text-wrapper-2">Trust Observability</div>
                <img className="iconsax-linear" alt="Iconsax linear" src="/img/iconsax-linear-building4-8.svg" />
              </div>
            </div>
            <div className="customer-2">
              <div className="frame-3">
                <div className="text-wrapper-2">Incident Monitoring</div>
                <img className="iconsax-linear" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1.svg" />
              </div>
              <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-49.svg" />
            </div>
            <div className="customer-2">
              <div className="frame-3">
                <img className="iconsax-linear-7" alt="Iconsax linear" src="/img/iconsax-linear-activity.svg" />
                <div className="text-wrapper-2">Activity Log</div>
              </div>
            </div>
          </>
                ...
                <img
                  ...
                  src={
                    ["EOAR", "incident-monitoring-expand"].includes(property1)
                      ? "/img/iconsax-linear-useroctagon-8.svg"
                      : "/img/iconsax-linear-useroctagon-7.svg"
                  }
                />
              ...
              <img
                ...
                src={
                  ["check-point", "checkpoint-2"].includes(property1)
                    ? "/img/iconsax-linear-arrowright2-50.svg"
                    : "/img/iconsax-linear-arrowright2-46.svg"
                }
              />
            </div>
              ...
              <>
                <div className="div">
                  <img
                    ...
                    alt="Iconsax linear"
                    src="/img/iconsax-linear-profile2user-8.svg"
                  />
                  <div className="group-3">
                    <div className="text-wrapper-3">Enforcement Point</div>
                    <img
                ...
                <div className="customer-3">
                  ...
                  <div className="group-5">
                    ...
                    <img
                      ...
                      src={
                        property1 === "compliance-moitoring"
                          ? "/img/iconsax-linear-arrowright2-42.svg"
                          : "/img/iconsax-linear-arrowright2-49.svg"
                      }
                    />
                  </div>
                </div>
                    ...
                    {["enforcement-2", "enforcement", "incident-monitoring-expand"].includes(property1) && (
                      <>
                        ...
                        <img
                          ...
                          src={
                            property1 === "incident-monitoring-expand"
                              ? "/img/iconsax-linear-building4-8.svg"
                              : "/img/iconsax-linear-arrowright2-50.svg"
                          }
                        />
                      </>
                ...
                <div className="roles-4">
                  ...
                  {property1 === "incident-monitoring-expand" && (
                    <img
                      ...
                      alt="Iconsax linear"
                      src="/img/iconsax-linear-arrowright2-50.svg"
                    />
                  )}
                </div>
                    ...
                    {property1 === "compliance-moitoring" && (
                      <>
                        ...
                        <img
                          className="iconsax-linear"
                          alt="Iconsax linear"
                          src="/img/iconsax-linear-building4-8.svg"
                        />
                      </>
                    )}
                  </div>
              ...
              <div className="roles-5">
                {property1 === "check-point" && (
                  <img
                    ...
                    alt="Iconsax linear"
                    src="/img/iconsax-linear-profile2user-2.svg"
                  />
                )}
                ...
                <div className="group-8">
                  ...
                  {property1 === "check-point" && (
                    <img
                      className="iconsax-linear-5"
                      alt="Iconsax linear"
                      src="/img/iconsax-linear-arrowright2-46.svg"
                    />
                  )}
                </div>
              </div>
                  ...
                  <>
                    ...
                    <div className="group-4">
                      ...
                      <img
                        className="iconsax-linear-6"
                        alt="Iconsax linear"
                        src="/img/iconsax-linear-arrowright2-49.svg"
                      />
                    </div>
                  </>
                )}
        ...
        {["EOAR", "checkpoint-2", "enforcement-2"].includes(property1) && (
          <img
            className="line-3"
            alt="Line"
            src={property1 === "EOAR" ? "/img/line-377-2.svg" : "/img/line-377-1.svg"}
          />
        )}
      </div>
    </div>
