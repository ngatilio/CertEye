...
export const Menu = ({
  ...
  divClassName,
  iconsaxLinear5 = "/img/iconsax-linear-arrowright2-13.svg",
          ...
          <div className="menu-items">
            ...
            {["compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <>
                ...
                <div className={`div ${customerClassNameOverride}`}>
                ...
                <div className="roles-3">
                  ...
                  <div className="group-6">
                    ...
                    {["check-point", "checkpoint-2", "compliance-moitoring"].includes(property1) && (
                      <div
                        className={`div-2 ${property1 === "compliance-moitoring" ? divClassNameOverride : undefined}`}
                      >
