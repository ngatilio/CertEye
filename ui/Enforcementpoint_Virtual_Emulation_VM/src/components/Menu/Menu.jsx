...
export const Menu = ({
  ...
  iconsaxLinear5 = "/img/iconsax-linear-arrowright2-14.svg",
  divClassName1,
      ...
      <div className={`menu-items-2 property-1-${property1}`}>
        ...
        {(property1 === "EOAR" ||
          ...
          <div className="menu-items">
            ...
            {["check-point", "compliance-moitoring", "enforcement", "incident-monitoring-expand"].includes(
              property1
            ) && (
              <>
                <div className="roles-3">
                  ...
                  <div className="group-6">
                    {["enforcement", "incident-monitoring-expand"].includes(property1) && (
                      <>
                        <div className="enforcement-point">
                          {property1 === "enforcement" && <>Enforcement Point</>}
                    ...
                    {["check-point", "compliance-moitoring"].includes(property1) && (
                      <div className="div-2">
                ...
                <div className="roles-4">
                  <div className="frame-4">
                    ...
                    {["check-point", "compliance-moitoring", "enforcement"].includes(property1) && (
                      <div className="div-2">
                ...
                <div className="customer-4">
                  <div className="group-7">
                    {["check-point", "enforcement", "incident-monitoring-expand"].includes(property1) && (
                      <div className="div-2">
                ...
                <div className="customer-5">
                  {["compliance-moitoring", "enforcement"].includes(property1) && (
                    <>
                      <div className="frame-5">
                        ...
                        {property1 === "enforcement" && <div className="div-2">Patching SandBox</div>}
                      </div>
                      <img
            ...
            {["checkpoint-2", "enforcement-2"].includes(property1) && (
              <div className={`roles-5 ${rolesClassName}`}>
                {property1 === "checkpoint-2" && (
                  <div className="group-8">
                    <div className="div-2">AI Testing Pipeline</div>
                  </div>
                )}
                ...
                {property1 === "enforcement-2" && (
                  <>
                    ...
                    <div className="group-3">
                      <div className={`text-wrapper-3 ${divClassName}`}>Enforcement Point</div>
              ...
              <>
                ...
                <div className="roles-8">
                  <div className="patching-sandbox-wrapper">
                    <div
                      className={`patching-sandbox ${property1 === "enforcement-2" ? divClassNameOverride : undefined}`}
                    >
                  ...
                  {property1 === "enforcement-2" && (
                    <img className="iconsax-linear-18" alt="Iconsax linear" src={iconsaxLinear5} />
                  )}
                </div>
                ...
                <div className="roles-9">
                  <div className="ethics-auto-testing-wrapper">
                    <div className={`ethics-auto-testing ${divClassName1}`}>
                ...
                {["check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
                  <>
                    <img
                      className="frame-2"
                      alt="Frame"
                      src={["checkpoint-2", "enforcement-2"].includes(property1) ? frame : "/img/frame-128-1.svg"}
                    />
                    <div className="group-4">
                      <div className="text-wrapper-3">Compliance Monitoring</div>
                      <img
            ...
            {property1 === "EOAR" && (
              <>
                <div className="roles-10">
                  ...
                  <img className="iconsax-linear-13" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
                </div>
                <div className="group-wrapper">
