      ...
      <div className={`logo-section ${property1}`}>
        {(property1 === "EOAR" ||
          ...
          <div className="logo-svg">
            <div className={`text-wrapper ${divClassName}`}>ZeroTrust 360</div>
          </div>
        )}
          ...
          <>
            ...
            <div className="menu-items">
              <div className="div">
                ...
                <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
              </div>
              <div className="roles">
              ...
              <div className="settings">
                ...
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
              </div>
              <div className="div">
                ...
                <div className="group-3">
                  ...
                  <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
                </div>
              </div>
              <div className="customer">
                ...
                <div className="group-4">
                  ...
                  <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
                </div>
              </div>
        ...
        {property1 === "side-menu" && (
          <>
            <div className="roles-2">
              ...
              <div className={`AI-policies-controls-2 ${AIPoliciesControlsClassName}`}>AI Policies &amp; Controls</div>
              <img
                className={`img ${iconsaxLinearClassName}`}
                alt="Iconsax linear"
            ...
            <div className="settings">
              <div className="frame">
                <div className={`text-wrapper-2 ${divClassNameOverride}`}>Check Point</div>
                <img className="iconsax-linear-2" alt="Iconsax linear" src={iconsaxLinear} />
              </div>
              <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
            </div>
            <div className="div">
              <img className="iconsax-linear-9" alt="Iconsax linear" src={img} />
              <div className="group-3">
                <div className={`text-wrapper-3 ${divClassName1}`}>Enforcement Point</div>
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-9.svg" />
              </div>
            </div>
            <div className="customer">
            ...
            <div className="customer-2">
              <div className="frame-3">
                <div className={`text-wrapper-2 ${divClassName2}`}>Trust Observability</div>
                <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear1} />
              </div>
            </div>
            <div className="customer-2">
              <div className="frame-3">
                <div className={`text-wrapper-2 ${divClassName3}`}>Incident Monitoring</div>
                <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear2} />
              </div>
              <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
            </div>
            <div className="customer-2">
              <div className="frame-3">
                <img className="iconsax-linear-7" alt="Iconsax linear" src={iconsaxLinear3} />
                <div className={`text-wrapper-2 ${divClassName4}`}>Activity Log</div>
              </div>
            </div>
          </>
        )}
            ...
            {property1 === "EOAR" && (
              <>
                <div className="roles-7">
                  ...
                  <img className="iconsax-linear-13" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-5.svg" />
                </div>
                <div className="group-wrapper">
