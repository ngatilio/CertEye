        ...
        {property1 === "policy-and-control" && (
          <>
            ...
            <div className="menu-items">
              <div className="div-2">
                <div className="group">
                  <img className="iconsax-linear-2" alt="Iconsax linear" src="/img/iconsax-linear-useroctagon-2.svg" />
                  <div className="AI-policies-controls">AI Policies &amp; Controls</div>
                </div>
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-11.svg" />
              </div>
              <div className="roles">
              ...
              <div className="settings">
                <div className="frame-2">
                  ...
                  <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-setting2-8.svg" />
                </div>
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-8.svg" />
              </div>
              <div className="div-2">
                <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-profile2user-7.svg" />
                <div className="group-3">
                  <div className="text-wrapper-3">Enforcement Point</div>
                  <img className="iconsax-linear-7" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-11.svg" />
                </div>
              </div>
              <div className="customer">
                <img className="frame-3" alt="Frame" src="/img/frame-128-1.svg" />
                <div className="group-4">
                  <div className="text-wrapper-3">Compliance Monitoring</div>
                  <img className="iconsax-linear-8" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-8.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-4">
                  <div className="text-wrapper-2">Trust Observability</div>
                  <img className="iconsax-linear-2" alt="Iconsax linear" src="/img/iconsax-linear-building4-1.svg" />
                </div>
              </div>
              <div className="customer-2">
                <div className="frame-4">
                  ...
                  <img
                    ...
                    alt="Iconsax linear"
                    src="/img/iconsax-linear-documenttext1-8.svg"
                  />
                </div>
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-8.svg" />
              </div>
              <div className="customer-2">
                <div className="frame-4">
                  <img className="iconsax-linear-9" alt="Iconsax linear" src="/img/iconsax-linear-activity-8.svg" />
        ...
        {property1 === "side-menu" && (
          <>
            <div className="roles-2">
              <img className="iconsax-linear-10" alt="Iconsax linear" src="/img/iconsax-linear-useroctagon-2.svg" />
            ...
            <div className="settings">
              ...
              <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-11.svg" />
            </div>
            <div className="div-2">
              <img className="iconsax-linear-11" alt="Iconsax linear" src="/img/iconsax-linear-profile2user-9.svg" />
              <div className="group-3">
                <div className="text-wrapper-3">Enforcement Point</div>
                <img className="iconsax-linear-7" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-11.svg" />
              </div>
            ...
            <div className="customer-2">
              <div className="frame-4">
                <div className="text-wrapper-2">Incident Monitoring</div>
                <img className="iconsax-linear-2" alt="Iconsax linear" src="/img/iconsax-linear-documenttext1-9.svg" />
              </div>
              <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-8.svg" />
            </div>
            <div className="customer-2">
              <div className="frame-4">
                <img className="iconsax-linear-9" alt="Iconsax linear" src="/img/iconsax-linear-activity-9.svg" />
                <div className="text-wrapper-2">Activity Log</div>
              </div>
            </div>
          </>
            ...
            {["compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <>
                <div className={`div-2 ${customerClassName}`}>
                  <img className="iconsax-linear-12" alt="Iconsax linear" src={iconsaxLinear3} />
                  <div className="group-3">
                    <div className="text-wrapper-3">Enforcement Point</div>
                    <img className="iconsax-linear-7" alt="Iconsax linear" src={iconsaxLinear4} />
                  </div>
                </div>
                <div className={`div-2 ${customerClassNameOverride}`}>
                  <img className="frame-3" alt="Frame" src={frame} />
                  <div className="group-5">
                    <div className={`text-wrapper-3 ${divClassName}`}>Compliance Monitoring</div>
                    <img
                ...
                <div className="roles-4">
                  <div className="frame-5">
                    ...
                    {["check-point", "checkpoint-2", "compliance-moitoring", "enforcement-2", "enforcement"].includes(
                      ...
                      <div
                        className={`div-3 ${property1 === "compliance-moitoring" ? divClassNameOverride : undefined}`}
                      >
                ...
                <div className="customer-3">
                  <div className="group-7">
                    ...
                    {property1 === "compliance-moitoring" && (
                      <>
                        <div className="text-wrapper-2">Trust Observability</div>
                        <img className="iconsax-linear-2" alt="Iconsax linear" src={iconsaxLinear6} />
                      </>
                    )}
                  </div>
                    ...
                    <>
                      <div className="frame-6">
                        {property1 === "compliance-moitoring" && (
                          <>
                            <div className="text-wrapper-2">Incident Monitoring</div>
                            <img className="iconsax-linear-2" alt="Iconsax linear" src={iconsaxLinear7} />
                          </>
                        )}
            ...
            {property1 === "EOAR" && (
              <>
                <div className="roles-7">
                  ...
                  <img className="iconsax-linear-15" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-7.svg" />
                </div>
                <div className="group-wrapper">
                ...
                <div className="customer-2">
                  <div className="frame-4">
                    <img className="iconsax-linear-9" alt="Iconsax linear" src="/img/iconsax-linear-activity-1.svg" />
                    <div className="text-wrapper-2">Activity Log</div>
                  </div>
                </div>
              </>
