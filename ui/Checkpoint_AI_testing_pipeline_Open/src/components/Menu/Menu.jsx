...
export const Menu = ({
  ...
  iconsaxLinear7 = "/img/iconsax-linear-arrowright2-7.svg",
  iconsaxLinear8 = "/img/iconsax-linear-activity-7.svg",
}) => {
  return (
      ...
      <div className={`logo-section ${property1}`}>
        {(property1 === "EOAR" ||
          ...
          <div className="logo-svg">
            <div className="text-wrapper-17">ZeroTrust 360</div>
          </div>
        )}

        {property1 === "policy-and-control" && (
          <>
            <img className="line" alt="Line" src="/img/line-376-10.svg" />
            <div className="menu-items">
              ...
              <div className="settings">
                <div className="frame">
                  <div className="div-4">Check Point</div>
              ...
              <div className="div-2">
                ...
                <div className="group-4">
                  <div className="text-wrapper-18">Enforcement Point</div>
              ...
              <div className="customer-2">
                <div className="frame-3">
                  ...
                  <div className="div-4">Activity Log</div>
                </div>
              </div>
            </div>
          </>
      ...
      <div className={`menu-items-2 property-1-${property1}`}>
          ...
          <div className="menu-items">
            <div className="roles-2">
              ...
              <img
                ...
                alt="Iconsax linear"
                src={
                  ["check-point", "enforcement"].includes(property1) ? img : "/img/iconsax-linear-arrowright2-10.svg"
                }
              />
            </div>
            {["check-point", "enforcement"].includes(property1) && (
              <div className={`settings-2 ${settingsClassName}`}>
                <div className="frame">
                  <div className={`div-4 ${divClassName}`}>Check Point</div>
                  <img className="iconsax-linear-2" alt="Iconsax linear" src={iconsaxLinear1} />
                </div>
                <img
                  className="img"
                  alt="Iconsax linear"
                  src={property1 === "enforcement" ? "/img/iconsax-linear-arrowright2-10.svg" : iconsaxLinear2}
                />
              </div>
            )}
            ...
            <div className="settings-3">
              {[
                ...
                <div className="group-6">
                  {property1 === "check-point" && (
                    <div className={`div-3 ${divClassNameOverride}`}>AI Testing Pipeline</div>
                  )}
                  ...
                  {["compliance-moitoring", "enforcement-2"].includes(property1) && (
                    <>
                      <div className="frame-4">
                        ...
                        {property1 === "enforcement-2" && <div className="div-3">Patching SandBox</div>}
                      </div>
                      <img
            ...
            {["EOAR", "check-point", "compliance-moitoring", "enforcement", "incident-monitoring-expand"].includes(
              ...
              <div className="customer-6">
                ...
                {["EOAR", "compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
                  <div className="frame-3">
                    {property1 === "EOAR" && <div className="div-4">Trust Observability</div>}
            ...
            {["check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
              <>
                <div className="customer-2">
                  ...
                  {["check-point", "enforcement"].includes(property1) && (
                    <img className="iconsax-linear-3" alt="Iconsax linear" src={iconsaxLinear7} />
                  )}
                </div>
                <div className="customer-2">
                  <div className="frame-3">
                    {["check-point", "enforcement"].includes(property1) && (
                      <img
                        ...
                        alt="Iconsax linear"
                        src={property1 === "enforcement" ? "/img/iconsax-linear-activity-6.svg" : iconsaxLinear8}
                      />
                    )}
            ...
            {property1 === "EOAR" && (
              <>
                <div className="roles-6">
                  ...
                  <img className="iconsax-linear-21" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
                </div>
                <div className="group-wrapper">
        ...
        {["EOAR", "checkpoint-2", "enforcement-2"].includes(property1) && (
          <img
            className="line-3"
            alt="Line"
            src={property1 === "EOAR" ? "/img/line-377-2.svg" : "/img/line-377-3.svg"}
          />
        )}
      </div>
    </div>
