      ...
      <div className={`logo-section ${property1}`}>
        {(property1 === "EOAR" ||
          ...
          <div className="logo-svg">
            <div className="text-wrapper-15">ZeroTrust 360</div>
          </div>
        )}
            ...
            <div className="menu-items">
              ...
              <div className="div-2">
                ...
                <div className="group-4">
                  <div className="text-wrapper-16">Enforcement Point</div>
              ...
              <div className="customer">
                ...
                <div className="group-5">
                  <div className="text-wrapper-16">Compliance Monitoring</div>
      ...
      <div className={`menu-items-2 property-1-${property1}`}>
        ...
        {(property1 === "EOAR" ||
          ...
          <div className="menu-items">
            ...
            {["check-point", "enforcement"].includes(property1) && (
              <div className={`roles-3 ${rolesClassName}`}>
                {property1 === "check-point" && (
                  <div className="group-6">
                    <div className="div-3">AI Testing Pipeline</div>
                  </div>
                )}
                ...
                {property1 === "enforcement" && (
                  <>
                    ...
                    <div className="group-4">
                      <div className={`text-wrapper-16 ${divClassName}`}>Enforcement Point</div>
                ...
                <div className="roles-4">
                  ...
                  <div className="group-8">
                    ...
                    {["check-point", "checkpoint-2", "compliance-moitoring", "enforcement"].includes(property1) && (
                      <div
                        className={`div-3 ${
                          ["check-point", "enforcement"].includes(property1) ? divClassNameOverride : undefined
                        }`}
                      >
                ...
                {["EOAR", "check-point", "enforcement"].includes(property1) && (
                  <div className="frame-3">
                    ...
                    <img
                      className="iconsax-linear"
                      alt="Iconsax linear"
                      src={property1 === "EOAR" ? "/img/iconsax-linear-documenttext1-1.svg" : iconsaxLinear7}
                    />
                  </div>
                )}
                  ...
                  <div className="frame-3">
                    {["check-point", "enforcement"].includes(property1) && (
                      <img
                        ...
                        alt="Iconsax linear"
                        src={property1 === "enforcement" ? iconsaxLinear10 : "/img/iconsax-linear-activity-7.svg"}
                      />
                    )}
