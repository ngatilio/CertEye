          ...
          <div className="menu-items">
            <div className="roles-2">
              ...
              <img
                className="img"
                alt="Iconsax linear"
                src={property1 === "EOAR" ? img : "/img/iconsax-linear-arrowright2-10.svg"}
              />
            </div>
            <div className="settings-2">
              <div className="frame">
                ...
                <img
                  ...
                  alt="Iconsax linear"
                  src={property1 === "EOAR" ? iconsaxLinear1 : "/img/iconsax-linear-setting2-1.svg"}
                />
              </div>
              <img
                className="img"
            ...
            {property1 === "EOAR" && (
              <>
                <div className={`div ${customerClassName}`}>
                  <img className="iconsax-linear-18" alt="Iconsax linear" src={iconsaxLinear3} />
                  <div className="group-3">
                    <div className="text-wrapper-3">Enforcement Point</div>
                ...
                <div className="customer">
                  ...
                  <div className="group-4">
                    <div className="text-wrapper-3">Compliance Monitoring</div>
                    <img className="iconsax-linear-6" alt="Iconsax linear" src={iconsaxLinear5} />
                  </div>
                </div>
                ...
                <div className={`customer-2 ${divClassName}`}>
                  <div className="frame-3">
                    <div className={`text-wrapper-2 ${divClassNameOverride}`}>Incident Monitoring</div>
                ...
                <div className="roles-7">
                  <div className="group-10">
                    <div className={`div-2 ${divClassName1}`}>AI EOAR</div>
                  </div>
                  <img className="iconsax-linear-13" alt="Iconsax linear" src={iconsaxLinear9} />
                </div>
                <div className="group-wrapper">
                ...
                <div className="group-wrapper">
                  <div className="group-14">
                    <div className={`div-3 ${divClassName2}`}>AI Threat Mitigation Matrix</div>
                  </div>
                </div>
                ...
                <div className="customer-2">
                  <div className="frame-3">
                    <img className="iconsax-linear-7" alt="Iconsax linear" src={iconsaxLinear10} />
                    <div className="text-wrapper-2">Activity Log</div>
                  </div>
                </div>
              </>
