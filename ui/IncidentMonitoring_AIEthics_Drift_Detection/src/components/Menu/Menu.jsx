...
export const Menu = ({
  ...
  rolesClassNameOverride,
  divClassName,
  iconsaxLinear7 = "/img/iconsax-linear-documenttext1-4.svg",
  iconsaxLinear8 = "/img/iconsax-linear-arrowright2-6.svg",
  iconsaxLinear9 = "/img/iconsax-linear-arrowright2-10.svg",
  divClassNameOverride,
  iconsaxLinear10 = "/img/iconsax-linear-activity-4.svg",
}) => {
  return (
          ...
          <>
            ...
            <div className="menu-items">
              <div className="div">
                ...
                <img className="img" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-10.svg" />
              </div>
              <div className="roles">
              ...
              <div className="settings">
                ...
                <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-7.svg" />
              </div>
              <div className="div">
                <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-profile2user-7.svg" />
                <div className="group-3">
                  <div className="div-4">Enforcement Point</div>
                  <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-10.svg" />
                </div>
              </div>
              <div className="customer">
                <img className="frame-2" alt="Frame" src="/img/frame-128-1.svg" />
                <div className="group-4">
                  <div className="div-4">Compliance Monitoring</div>
                  <img className="iconsax-linear-6" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-7.svg" />
                </div>
              </div>
      ...
      <div className={`menu-items-2 property-1-${property1}`}>
        {property1 === "side-menu" && (
          <>
            <div className="roles-2">
              <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-useroctagon-2.svg" />
            ...
            <div className="settings">
              ...
              <img className="iconsax-linear-3" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-10.svg" />
            </div>
            <div className="div">
              <img className="iconsax-linear-4" alt="Iconsax linear" src="/img/iconsax-linear-profile2user-9.svg" />
              <div className="group-3">
                <div className="div-4">Enforcement Point</div>
                <img className="iconsax-linear-5" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-10.svg" />
              </div>
        ...
        {(property1 === "EOAR" ||
          ...
          <div className="menu-items">
              ...
              <img
                ...
                src={
                  ["compliance-moitoring", "incident-monitoring-expand"].includes(property1)
                    ? img
                    : "/img/iconsax-linear-arrowright2-10.svg"
                }
              />
            </div>
              ...
              <div className="frame">
                ...
                <img
                  ...
                  src={
                    ["compliance-moitoring", "incident-monitoring-expand"].includes(property1)
                      ? iconsaxLinear1
                      : "/img/iconsax-linear-setting2-1.svg"
                  }
                />
              </div>
              <img
                ...
                src={
                  ["check-point", "checkpoint-2"].includes(property1)
                    ? "/img/iconsax-linear-arrowright2-6.svg"
                    : ["compliance-moitoring", "incident-monitoring-expand"].includes(property1)
                    ? iconsaxLinear2
                    : "/img/iconsax-linear-arrowright2-10.svg"
                }
            ...
            {["compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <div className={`div ${customerClassName}`}>
                <img className="iconsax-linear-4" alt="Iconsax linear" src={iconsaxLinear3} />
                <div className="group-3">
                  <div className="div-4">Enforcement Point</div>
            ...
            {["EOAR", "compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <div className="div">
                <img
                  ...
                  alt="Iconsax linear"
                  src={property1 === "EOAR" ? "/img/iconsax-linear-profile2user-1.svg" : frame}
                />
                <div className="group-5">
                  <div className="div-4">
                    {property1 === "EOAR" && <>Enforcement Point</>}
                  ...
                  <img
                    ...
                    src={
                      property1 === "compliance-moitoring"
                        ? "/img/iconsax-linear-arrowright2-14.svg"
                        : property1 === "incident-monitoring-expand"
                        ? iconsaxLinear5
                        : "/img/iconsax-linear-arrowright2-6.svg"
                    }
            ...
            {["compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <>
                <div className={`group-wrapper ${rolesClassName}`}>
                  <div className="group-6">
                    {property1 === "compliance-moitoring" && <div className="div-2">Compliance Statistics</div>}

                    {property1 === "incident-monitoring-expand" && (
                      <>
                        <div className="div-3">Trust Observability</div>
                        <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear6} />
                      </>
                    )}
                  </div>
                </div>
                <div className={`roles-3 ${rolesClassNameOverride}`}>
                  <div className="frame-4">
                    {property1 === "incident-monitoring-expand" && (
                      <>
                        <div className={`div-3 ${divClassName}`}>Incident Monitoring</div>
                        <img className="iconsax-linear" alt="Iconsax linear" src={iconsaxLinear7} />
                      </>
                    )}

                    {property1 === "compliance-moitoring" && <div className="div-2">Compliance Risks</div>}
                  </div>
                  {property1 === "incident-monitoring-expand" && (
                    <img className="iconsax-linear-3" alt="Iconsax linear" src={iconsaxLinear8} />
                  )}
                </div>
              </>
            )}
            ...
            {[
              ...
              <>
                <div className="customer-3">
                  {["check-point", "checkpoint-2", "compliance-moitoring", "incident-monitoring-expand"].includes(
                    property1
                  ) && (
                  ...
                  {property1 === "incident-monitoring-expand" && (
                    <img className="iconsax-linear-10" alt="Iconsax linear" src={iconsaxLinear9} />
                  )}
                    ...
                    <>
                      ...
                      <div className="group-3">
                        ...
                        <img
                          ...
                          alt="Iconsax linear"
                          src="/img/iconsax-linear-arrowright2-6.svg"
                        />
                      </div>
                    </>
                  )}
                ...
                <div className="roles-4">
                  {[
                    ...
                    <div className="checker-playbooks-wrapper">
                      <div
                        className={`div-2 ${
                          property1 === "incident-monitoring-expand" ? divClassNameOverride : undefined
                        }`}
                      >
            ...
            {["check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
              <>
                <div className="roles-5">
                  <div className="enforcer-playbooks-wrapper">
                    <div className="div-2">
                  ...
                  {["check-point", "checkpoint-2"].includes(property1) && (
                    <img
                      ...
                      alt="Iconsax linear"
                      src="/img/iconsax-linear-arrowright2-14.svg"
                    />
                  )}
                </div>
                <div className="roles-6">
                  <div className="patching-sandbox-wrapper">
                    <div className="patching-sandbox">
                      {["enforcement-2", "enforcement"].includes(property1) && <>Patching SandBox</>}
                  ...
                  <div className="group-8">
                    ...
                    {property1 === "check-point" && (
                      <img
                        className="iconsax-linear-5"
                        alt="Iconsax linear"
                        src="/img/iconsax-linear-arrowright2-10.svg"
                      />
                    )}
                  </div>
                </div>
                ...
                <div className="customer-2">
                  <div className="frame-3">
                    ...
                    <img
                      ...
                      src={
                        property1 === "EOAR"
                          ? "/img/iconsax-linear-documenttext1-1.svg"
            ...
            {property1 === "EOAR" && (
              <>
                <div className="roles-10">
                  <div className="group-10">
                    <div className="div-2">AI EOAR</div>
                  </div>
                  <img className="iconsax-linear-10" alt="Iconsax linear" src="/img/iconsax-linear-arrowright2-6.svg" />
                </div>
                <div className="roles-8">
                  <div className="group-11">
                    <div className="div-5">AI Incident Response</div>
                  </div>
                </div>
                <div className="roles-8">
                  <div className="group-12">
                    <div className="div-5">AI Tool vulnerability</div>
                  </div>
                </div>
                <div className="roles-8">
                  <div className="group-13">
                    <div className="div-5">Targeted AI models</div>
                  </div>
                </div>
                <div className="roles-8">
                  <div className="group-14">
                    <div className="div-5">AI Threat Mitigation Matrix</div>
                  </div>
                </div>
                <div className="roles-11">
