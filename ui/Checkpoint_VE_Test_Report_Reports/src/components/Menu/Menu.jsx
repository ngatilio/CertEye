      ...
      <div className={`menu-items-2 property-1-${property1}`}>
          ...
          <div className="menu-items">
            <div className="roles-2">
              ...
              <img
                ...
                alt="Iconsax linear"
                src={
                  ["checkpoint-2", "enforcement-2"].includes(property1) ? img : "/img/iconsax-linear-arrowright2-10.svg"
                }
              />
            </div>
            {["checkpoint-2", "enforcement-2"].includes(property1) && (
              <div className={`settings-2 ${settingsClassName}`}>
                ...
                <img
                  className="img"
                  alt="Iconsax linear"
                  src={property1 === "enforcement-2" ? "/img/iconsax-linear-arrowright2-10.svg" : iconsaxLinear2}
                />
              </div>
            )}
            ...
            <div className="settings-3">
              {[
                ...
                <div className="group-6">
                  {property1 === "checkpoint-2" && <div className="div-2">AI Testing Pipeline</div>}
            ...
            {["check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
              <>
                <div className="roles-3">
                  {["check-point", "checkpoint-2", "enforcement-2"].includes(property1) && (
                    <div className="checker-playbooks-wrapper">
                      <div className="div-2">
                        ...
                        {property1 === "check-point" && <>AI Testing Pipeline</>}
                      </div>
                    </div>
                  )}
                ...
                <div className="roles-4">
                  <div className="enforcer-playbooks-wrapper">
                    <div className={`div-2 ${property1 === "checkpoint-2" ? divClassNameOverride : undefined}`}>
                ...
                <div className="roles-5">
                  <div className="patching-sandbox-wrapper">
                    <div className="patching-sandbox">
                      {property1 === "enforcement-2" && <>Patching SandBox</>}
                  ...
                  {["check-point", "enforcement-2"].includes(property1) && (
                    <img
                ...
                <div className="roles-6">
                  ...
                  {property1 === "enforcement" && (
                    <>
                      <div className="group-2">
                        <div className="div-2">Patching SandBox</div>
                      </div>
                      <img
                ...
                <div className="roles-7">
                  ...
                  <div className="group-7">
                    ...
                    {["checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
                      <div
                        className={`VE-test-report-2 ${
                          ["checkpoint-2", "enforcement-2"].includes(property1) ? divClassName1 : undefined
                        }`}
                      >
            ...
            {["checkpoint-2", "enforcement-2"].includes(property1) && (
              <>
                ...
                <div className="customer-3">
                  {property1 === "checkpoint-2" && (
                    <>
                      <img className="iconsax-linear-16" alt="Iconsax linear" src={iconsaxLinear3} />
                      <div className="group-8">
                        <div className="div-4">Enforcement Point</div>
                        <img className="iconsax-linear-17" alt="Iconsax linear" src={iconsaxLinear4} />
                      </div>
                    </>
                  )}
              ...
              <img
                ...
                src={
                  ["check-point", "enforcement"].includes(property1)
                    ...
                    : ["checkpoint-2", "enforcement-2"].includes(property1)
                    ? frame
                    : "/img/iconsax-linear-profile2user-1.svg"
                }
              />
            ...
            {["EOAR", "check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
              <div className="customer-2">
                <div className="frame-3">
                  <div className="div-3">
                    {property1 === "EOAR" && <>Trust Observability</>}
            ...
            {["EOAR", "check-point", "checkpoint-2", "enforcement-2", "enforcement"].includes(property1) && (
              <div className="customer-2">
                <div className="frame-3">
                  {property1 === "EOAR" && <div className="div-3">Incident Monitoring</div>}
            ...
            {["EOAR", "compliance-moitoring", "incident-monitoring-expand"].includes(property1) && (
              <>
                ...
                <div className="roles-9">
                  {["EOAR", "compliance-moitoring"].includes(property1) && (
                    <div className="AI-incident-response-wrapper">
                      <div className="AI-incident-response">
                        {property1 === "EOAR" && <>AI Incident Response</>}
                  ...
                  {["EOAR", "compliance-moitoring"].includes(property1) && (
                    <div className="frame-5">
                      <div className="AI-tool">
                        {property1 === "EOAR" && <>AI Tool vulnerability</>}

                        {property1 === "compliance-moitoring" && <>Trust Observability</>}
                      </div>
                      {property1 === "compliance-moitoring" && (
                        <img
                          className="iconsax-linear"
                  ...
                  {["EOAR", "incident-monitoring-expand"].includes(property1) && (
                    <div className="AI-ethics-drift-wrapper">
                      <div className="AI-ethics-drift">
                        ...
                        {property1 === "EOAR" && <>Targeted AI models</>}
                      </div>
                    </div>
                  )}
                </div>
              ...
              <>
                <div className="roles-10">
                  <div className="group-13">
                    <div className="text-wrapper-2">AI Threat Mitigation Matrix</div>
                  </div>
                </div>
                  ...
                  <img
                    ...
                    src={
                      property1 === "compliance-moitoring"
                        ...
                        : "/img/iconsax-linear-activity-1.svg"
                    }
                  />
                  <div className="div-3">Activity Log</div>
                </div>
        ...
        {["EOAR", "checkpoint-2", "enforcement-2"].includes(property1) && (
          <img
            className="line-3"
            alt="Line"
            src={property1 === "EOAR" ? "/img/line-377-1.svg" : "/img/line-377-2.svg"}
          />
        )}
      </div>
    </div>
