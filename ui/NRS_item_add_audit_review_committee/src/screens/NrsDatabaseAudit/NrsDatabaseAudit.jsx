    ...
    <div className="NRS-database-audit">
      <div className="div-4">
          ...
          <div className="group-16">
            <div className="overlap-group-3">
              ...
              <div className="navbar">
                ...
                <div className="text-wrapper-9">Audit Review Comittee</div>
              </div>
            </div>
          </div>
          <img className="rectangle" alt="Rectangle" src="/img/rectangle-3700.svg" />
        </div>
        ...
        <div className="NRS-database-list">
          ...
          <div className="text-wrapper-13">Audit Review Committee</div>
          ...
          <div className="group-20">
            ...
            <img className="component" alt="Component" src="/img/component-45-536-1.png" />
          </div>
          ...
          <img className="path" alt="Path" src="/img/path-2177.svg" />
          <img className="path-2" alt="Path" src="/img/path-2177.svg" />
          <img className="path-3" alt="Path" src="/img/path-2177.svg" />
          <div className="text-wrapper-15">Nextbrain</div>
          <div className="nextbrain">Infosys</div>
          <div className="nextbrain-2">Wipro</div>
        </div>
        <Menu
          ...
          img="/img/iconsax-linear-arrowright2-49.svg"
        ...
        />
        <img className="rectangle-2" alt="Rectangle" src="/img/rectangle-3602.svg" />
        <div className="rectangle-3" />
        <div className="group-24">
          <p className="add-a-new-company">Add people to Audit committee</p>
          <p className="UX-research-for">Invite a person to this NRS as a member</p>
          ...
          <div className="group-27">
            ...
            <img className="component-2" alt="Component" src="/img/component-45-536.png" />
          </div>
          <p className="p">Members already in this audit committee</p>
          ...
          <div className="frame-7">
            <div className="group-29">
              <div className="name-of-the-company">Email ID</div>
              <div className="blinkbee-wrapper">
                <div className="blinkbee">ameliaparker@nextbraintech.com</div>
              </div>
            </div>
            <button className="button-3">
              <div className="overlap-3">
                <div className="cancel-2">+ Add new</div>
                <img className="line-4" alt="Line" src="/img/line-286.svg" />
              </div>
            </button>
          </div>
        </div>
